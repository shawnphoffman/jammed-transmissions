...
export default async function UpdatesPage() {
	...
	return (
		<div className="w-full max-w-screen-lg mb-8 border rounded-lg border-slate-800 bg-slate-950/50">
			<div className="flex flex-col justify-center w-full p-2 divide-y divide-slate-800">
